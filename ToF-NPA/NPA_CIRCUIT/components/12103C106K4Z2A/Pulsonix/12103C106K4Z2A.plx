...
//778579/1356296/2.50/2/3/Capacitor
...
(library Library_1
	...
	(patternDef "CAPC3225X279N" (originalName "CAPC3225X279N")
		(multiLayer
	...
	(symbolDef "12103C106K4Z2A" (originalName "12103C106K4Z2A")
	...
	(compDef "12103C106K4Z2A" (originalName "12103C106K4Z2A") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "12103C106K4Z2A"))
		(attachedPattern (patternNum 1) (patternName "CAPC3225X279N")
			(numPads 2)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "12103C106K4Z2A")
		(attr "Description" "AVX - 12103C106K4Z2A - SMD Multilayer Ceramic Capacitor, 10 F, 25 V, 1210 [3225 Metric], +/- 10%, X7R, AVX 1210 MLCC")
		(attr "<Hyperlink>" "https://spicat.kyocera-avx.com/product/mlcc/chartview/12103C106K4Z2A/DataSheet/X7R")
		(attr "<Component Height>" "2.79")
		(attr "<STEP Filename>" "12103C106K4Z2A.stp")
